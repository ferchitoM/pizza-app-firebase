...
public class DrinksListAdapter extends RecyclerView.Adapter<DrinksListAdapter.myViewHolder> {

    private Context             context;
    private ArrayList<Product>  productList;
    private DrinksPresenter     presenter;

    public DrinksListAdapter(Context context, ArrayList<Product> productList, DrinksPresenter presenter) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.list_drinks_layout, parent, false);
